...
export default function BudgetMonthlyDashboardScreen(props) {
  ...
  const [Grocery, setGrocery] = useState(["Grocery", Object.values(props.budget)[0].grocery]);

  const [Food, setFood] = useState(["Food", Object.values(props.budget)[0].food]);

  const [Clothes, setClothes] = useState(["Clothes", Object.values(props.budget)[0].clothes]);
